  ...
  <div class="app-container">
    ...
    <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
      <el-form-item label="用户名称" prop="account">
        <el-input v-model="queryParams.account" placeholder="请输入用户名称" clearable size="small" @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  computed: {
    newAccount() {
      return this.queryParams.account
    }
  },
  watch: {
    newAccount(val) {
      this.queryParams.account = val === '' ? undefined : val
    }
  },
  created() {
    this.getList()
